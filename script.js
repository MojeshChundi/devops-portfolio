...
const revealElements = document.querySelectorAll('.about-text, .contact-item');
...
// Console message
console.log('%c👋 Welcome to my DevOps Portfolio!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
